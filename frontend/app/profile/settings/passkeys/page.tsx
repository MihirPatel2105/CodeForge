      ...
      <div className="grid items-start gap-5 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
          ...
          >
            ...
            <div className="mt-6 space-y-5">
              ...
              <p className="flex items-start gap-2 rounded-lg border border-rule bg-bg px-3 py-2.5 text-[12px] leading-5 text-fg-muted">
          ...
          <section className="rounded-xl border border-border bg-surface px-6 py-7 shadow-[0_16px_45px_rgba(22,24,28,0.045)] md:px-7">
            ...
            {loadingPasskeys ? (
              ...
              <div className="mt-6 rounded-xl border border-dashed border-border-strong bg-bg px-5 py-8 text-center">
                ...
                {passkeys.map((item) => (
                  ...
                  >
                    <div className="flex min-w-0 items-start gap-3">
                      <span className="grid h-9 w-9 shrink-0 place-items-center rounded-lg border border-accent-bd bg-accent-soft text-accent">
        ...
        {message && (
          <p
            role="status"
            className="mt-5 rounded-lg border border-accent-bd bg-accent-soft p-3 text-[13px] text-accent"
          >
            {message}
          </p>
        )}
